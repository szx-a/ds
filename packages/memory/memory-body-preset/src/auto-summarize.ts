 ...
 *
 * @module @2464500754/dsh-layered-memory-architecture-preset/auto-summarize
 */

import type { Context } from '@deepseek-ai/cordis'
import type { Agent } from '@deepseek-ai/dsh-agent'
import { summarizeIntoBody } from '@2464500754/dsh-layered-memory-architecture/summarize'
